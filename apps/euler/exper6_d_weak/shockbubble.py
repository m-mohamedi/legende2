...
def shockbubble(finalt=1,use_petsc=False,iplot=False,htmlplot=False,outdir='./_output',solver_type='classic'):
    """
    ...
    tfinal = finalt # 0.02/np.sqrt(size)
    import time
    start=time.time()
    ...
    if rank ==0:
        ...
        print 'time reduction time',t2-t1
...
if __name__=="__main__":
    ...
    if rank in proccessesList:
        funccall = "shockbubble(finalt=0.02/np.sqrt(size),use_petsc=True,outdir='exper6_d/_output_p3')"
